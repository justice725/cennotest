...
<header id="hd">
    <nav id="nav">
        ...
        <div class="manu">
            <a href="./introduce.php" class="nav_list nav_list1">기업소개</a>
                        ...
                        <nav class="ul">
                            <ul class="fnb">
                                <li class="fnb_li_1 on1">
                                    <a href="./introduce.php" class="fnbA"><span>기업 소개</span> <span class="span_bar"></span></a>
                                    <ul class="sub_1 sub">
                                        <li class="on1"><a href="./introduce.php"> <span>회사 소개</span> <span class="span_bar"></span></a></li>
                                        <li class="on1"><a href="./greet.php"> <span>CEO인사말</span> <span class="span_bar"></span></a></li>
                                        <li class="on1"><a href="./history.php"> <span>회사 연혁</span> <span class="span_bar"></span></a></li>
                                        <li class="on1"><a href="./map.php"> <span>오시는 길</span> <span class="span_bar"></span></a></li>
                                    </ul>
                                </li>
...
<div class="hd_visual">
    <div class="manu">
        <div class="menu_sub__1" style="padding: 0">
            <a href="./introduce.php" style="display: none;">회사 소개</a>
            <a href="./greet.php" style="display: none;">CEO 인사말</a>
            <a href="./history.php" style="display: none;">회사 연혁</a>
            <a href="./map.php" style="display: none;">오시는 길</a>
        </div>
        ...
        <div class="menu_sub__7" style="padding: 0">
            <a href="./board/board.php" style="display: none;">공지사항</a>
            <a href="./board/cs_center.php" style="display: none;">1:1문의</a>
        </div>
